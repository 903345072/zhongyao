        ...
        <div class="col-xs-12">
            <div class="media">
                ...
                <div class="media-body">
                    <!--  <p>经纪人姓名:李丽丽</p> -->
                    <p>下线客户:<?= count($idArr[0]) ?>人</p>
                    <p>交易总额:<?= array_sum($data['amount']) ?>￥</p>
                    <p>手续费总额:<?= array_sum($data['fee']) ?>￥</p>
...
<div class="container bg_h">
    <div class="row head">
        ...
        <div class="col-xs-4 title lineright"><span>手续费总额</span></div>
        <div class="col-xs-4 title"><span>返点总额</span></div>
    </div>
    <div class="row content">
        <div class="col-xs-4 list"><span>推广费</span></div>
        <div class="col-xs-4 list"><span><?= $data['fee'][0] ?>￥</span></div>
