...
<div class="am-padding-lg am-text-center">
    <img src="/images/zhifubao.jpg" class="wid75">
</div>
...
<div class="am-padding-sm am-padding-top-0">
    ...
    <div>
        <input type="text" name="" id="name" class="am-form-field" placeholder="填写支付宝账号，方便财务审核，快速入账">
    </div>
