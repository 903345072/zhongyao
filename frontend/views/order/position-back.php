                                ...
                                <div class="mui-table">
                                    <div class="mui-table-cell mui-col-xs-4 uk-text-middle">
                                        <div class="mui-ellipsis">
                                            ...
                                            <span class=" ">止盈 +<?=getCurrencySymbol($v->currency);?> <?=$v->stop_profit_price ?></span>
                                        </div>
                                        <div class="mui-ellipsis">
                                            <span class=" ">止损 -<?=getCurrencySymbol($v->currency);?> <?=$v->stop_loss_price?></span>
                                        </div>
                                    </div>
...
<!--                                            止损卖出-->
                                ...
                                <div class="mui-table">
                                    <div class="mui-table-cell mui-col-xs-4 uk-text-middle">
                                        <div class="mui-ellipsis">
                                            <span class=" ">止盈 + <?=getCurrencySymbol($v->currency);?><?=$v->stop_profit_price;?>元</span>
                                        </div>
                                        <div class="mui-ellipsis">
                                            <span class=" ">止损 - <?=getCurrencySymbol($v->currency);?><?=$v->stop_loss_price;?>元</span>
                                        </div>
                                    </div>
                                    <div class="mui-table-cell mui-col-xs-5 uk-text-middle mui-text-center">
                                        <div class="mui-ellipsis">
