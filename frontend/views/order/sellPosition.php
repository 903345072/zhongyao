...
<div class="container">
    <div class="liq_box">
        ...
        <div class="row">
            <div class="liq_main">
                <div class=" liq_box_hx">
                    <p class="liq_span col-xs-6">
                        <font class="liq_font">手续费&nbsp;&nbsp;:</font>
                        ￥<?= $order->fee ?>
                    </p>
                    <?php if ($order->stop_loss_price / $order->deposit * 100 != 0) :?>
                        <div class="col-xs-6  liq_borders liq_box_hx" style="border-left:1px solid #191919;margin-left:-1px" >
                            <font class="liq_font">保本价&nbsp;&nbsp;:</font>
                            <span class="styled-select" id="endloss"> &nbsp;&nbsp;
                                  <?php if ($order->rise_fall == 1) : ?>          
                                  <?= $order->price - ($order->stop_loss_price / $order->one_profit) ?>    
                                  <?php else: ?>
                                  <?= $order->price + ($order->stop_loss_price / $order->one_profit) ?>
                                  <?php endif ?>
                            </span>
