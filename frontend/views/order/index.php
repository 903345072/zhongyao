...
<!--                                 <div class="col-xs-6 mar text-center">
                            ...
                            <div class="cash-box-width bor-none">
                                ...
                                <p class="text-left">手续费<span class="pad_l20 productFee"><?= $productPrice[0]['fee'] ?></span>元/手</p>
                        ...
                        <div class="cash-box mar_t10 mar_b30">
                            ...
                            <div class="col-xs-10 pad_r0 pad_t10 po_re">
                                <ul class="font_12 text-left">
                                    ...
                                    <li>2.交易时间：周一~周五早上7:00~凌晨4:00 周末休市</li>
                                    <!-- <li>3.白银交易更灵活,无以上限制</li> -->
                                </ul>
                    ...
                    <div class="feature pad_t20 mar_0">
                        ...
                        <div class="cash-box mar_t10 mar_b30">
                            ...
                            <div class="col-xs-10 text-left mar">
                                <p class="font_12 pad_t10">体验券仅为一次性本金使用，盈利后您只能获得其中利益，而亏损您无需承担。体验券可通过分享好友加入获得。</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        $('.payOrder').click(function() {
            ...
            if (data.type == 1) {
                ...
                if (data.hand > allNumber || data.hand < 1) {
                    return $.alert('体验券的数量非法！');
                }
                if (data.hand > 10) {
                    return $.alert('体验券的数量不能超过10个！');
                }
                var bool = false;
                tes(productPrice,data.deposit);
