    ...
    <section class="page-main main-withdrawal" style="background:#fff">
        <div class="content">
            ...
            <div style="margin: 0 auto; width: 210px">
                <button style="margin:auto 0px;width:210px; height:50px; border-radius: 15px;background-color:#FE6714; border:0px #FE6714 solid; cursor: pointer;  color:white;  font-size:16px;" type="button" id="payBtn" onclick="callpay()">立即支付</button>
            </div>
        </div>
    </section>
