<!DOCTYPE html>
<!-- saved from url=(0044)http://130161.com/member/index/chongzhi.html -->
<html>
	...
	<body class="mui-ios mui-ios-11 mui-ios-11-0"><noscript>&lt;meta HTTP-EQUIV="refresh" content="0;url='http://192.168.0.10:6001/member/index/chongzhi.html?PageSpeed=noscript'" /&gt;&lt;style&gt;&lt;!--table,div,span,font,p{display:none} --&gt;&lt;/style&gt;&lt;div style="display:block"&gt;Please click &lt;a href="http://192.168.0.10:6001/member/index/chongzhi.html?PageSpeed=noscript"&gt;here&lt;/a&gt; if you are not redirected within a few seconds.&lt;/div&gt;</noscript>
		<header class="mui-bar mui-bar-nav">
			<a class="mui-icon mui-icon-left-nav mui-pull-left" href=""></a>
			<h1 class="mui-title">充值</h1>
			<a class="mui-btn mui-btn-link mui-pull-right" href="">充值记录</a>
		</header>
		<div class="mui-content">
			<div>
				<iframe src="<?= url(['user/rechargeMoney']) ?>" frameborder="0" scrolling="auto" style="width: 100%; height: 627px;" id="framid"></iframe>
			</div>
		</div>
		<script type="text/javascript">
			var wheight = $(window).height();
			$('#framid').height(wheight - 40);
		</script>
