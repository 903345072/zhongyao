<!DOCTYPE html>
<!-- saved from url=(0071)http://130161.com/Member/index/buy_zhang/prono/EC1806/id/35/moni/0.html -->
<html>
	<head>
...
var zhiyingbs = parseFloat(5);</script>
		<script type="text/javascript">var durl = "http%3A%2F%2F130161.com%2FMember%2Findex%2Fchicang%2Fprono%2FEC1806%2Fid%2F35%2Fmoni%2F0.html";
...
function check_success(orderid) {
	$.post("/Member/index/check_order.html", {
		orderid: orderid
	}, function(datajson) {
		if(datajson.status > 0) {
			...
			layer.closeAll('loading');
			layer.alert("交易失败，请重试")
		} else {
			setTimeout(function() {
				check_success(orderid);
			}, 1000);
		}
	});
}
			...
			<div class="mui-table buttom-buttons">
				<div class="mui-table-cell mui-col-xs-8">
					<div class="tm-panel-padded-0-10 uk-text-muted">
						<span class="">合计：<em class="uk-text-warning"><font id="totalprice">1968.00</font>元</em></span>
					</div>
				</div>
				<a class="mui-btn mui-btn-theme mui-table-cell mui-col-xs-4 ajaxpost_form" confirm-func="confirm_returnmsg" formid="orderform" before-function="set_form_data" ajax-error-callback="select_chose" ajax-callback="setcall" ajaxurl="/Member/index/add_order.html" href="Javascript:">
					确定买涨
				</a>
			</div>
		</div>
		...
		<div class="mui-content">
			<div class="">
				<form id="orderform">
					...
					<input type="hidden" name="info[totalprice]" value="1968.00" id="tprice">
					<input type="hidden" name="info[moni]" value="0">
					<input type="hidden" name="info[price]" value="1.2425" id="F_price">
					<input type="hidden" name="info[baozhengjin]" value="" id="F_baozhengjin">
					<input type="hidden" name="info[jiaoyi_price]" value="" id="F_jiaoyi">
					<input type="hidden" name="info[ordertype]" value="0">
						...
						<li class="mui-table-view-cell mui-media">
							<div class="mui-table">
								<div class="mui-table-cell mui-col-xs-3">
									<div class="mui-ellipsis">
										<span class="uk-text-muted">购买手数1</span>
									</div>
								</div>
...
$(function() {
	...
	set_goods_nums(1, 1);
							...
							<div class="mui-table">
								...
								<div class="mui-table-cell mui-col-xs-6">
									<div class="uk-input-blank uk-input-blank-transparent">
										<input id="lastprice" class="uk-input" name="price" type="text" value="1.24240" readonly="">
									</div>
								</div>
					...
					<ul class="mui-table-view mui-in-zero  mui-table-view-inverted-2">
						...
						<li class="mui-table-view-cell  mui-media">
							<span class="mui-pull-right">￥<em id="jiaoyifei">168</em>($<em id="jiaoyifei_rate">23.33</em>)</span>
							<div class="mui-media-body mui-ellipsis">
						...
						<li class="mui-table-view-cell  mui-media">
							<span class="mui-pull-right">￥<em id="baozhengjin">1800.00</em>($<em id="baozhengjin_rate">250.00</em>)</span>
							<div class="mui-media-body mui-ellipsis">
		...
		<div class="this-modal" id="modal-1">
			...
			<div class="this-modal-body">
				<ul class="chose-gird mui-clearfix" id="zhisun_modal">
					<li>
						<a class="chose-item zhisun_show mui-active" moneyico="$" rate="7.2" nums="200" href="Javascript:">
							-1440.00($200)
						</a>
					</li>
					<li>
						<a class="chose-item zhisun_show " moneyico="$" rate="7.2" nums="400" href="Javascript:">
							-2880.00($400)
						</a>
					</li>
					<li>
						<a class="chose-item zhisun_show " moneyico="$" rate="7.2" nums="600" href="Javascript:">
							-4320.00($600)
						</a>
					</li>
					<li>
						<a class="chose-item zhisun_show " moneyico="$" rate="7.2" nums="1000" href="Javascript:">
							-7200.00($1000)
						</a>
					</li>
					<li>
						<a class="chose-item zhisun_show " moneyico="$" rate="7.2" nums="1600" href="Javascript:">
							-11520.00($1600)
						</a>
					</li>
					<li>
						<a class="chose-item zhisun_show " moneyico="$" rate="7.2" nums="2000" href="Javascript:">
							-14400.00($2000)
						</a>
					</li>
				</ul>
