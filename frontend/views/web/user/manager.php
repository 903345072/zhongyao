        ...
        <div class="container">
            ...
            <div class="pay_box mar_t">
                ...
                <div class="row inputs_box">
                    ...
                    <div class="col-xs-12 name_input">
                        <div>
                            <?= $form->field($userAccount, 'bank_name')->textInput(['placeholder' => '开户银行']) ?>
                        </div>
                        <div class="input_del">
                        ...
                        <div class="input_del" style="display:none;">
                            <?= $form->field($userAccount, 'coding')->textInput(['placeholder' => '代理商邀请码']) ?>
                        </div>
                    </div>
                </div>
                <div class="row space">
