...
<?php foreach ($models as $key => $model): ?>
    <tr class="trade-time-row">
        ...
        <td><?= $form->field($model, "[$key]hand")->textInput(['placeholder' => $model->label('hand')]) ?></td>
        <td><?= $form->field($model, "[$key]stop_profit_price")->textInput(['placeholder' => $model->label('stop_profit_price')]) ?></td>
        <td><?= $form->field($model, "[$key]stop_loss_price")->textInput(['placeholder' => $model->label('stop_loss_price')]) ?></td>
        <td><?= $form->field($model, "[$key]point_unit")->textInput(['placeholder' => $model->label('point_unit')]) ?></td>
