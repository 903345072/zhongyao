...
//                test(FileHelper::getDirs(Yii::getAlias('@webroot')));
                if($this->id != 'web')
                {
    ...
    {
        $allowActions = ['kline', 'get-price','captcha', 'notify', 'index', 'znnotify', 'verify-code','read','userpayment','feedback','get-data','ajax-all-product','register', 'ajax-read-message'];
