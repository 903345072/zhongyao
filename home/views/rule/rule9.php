<div class="box">
    ...
    <div class="am-padding-horizontal-xs am-padding-bottom-sm am-text-sm">
        ...
        <div style="padding:10px;line-height: 25px;font-size: 14px;background: none">
            ...
            <p style="list-style: none; padding: 0px; text-indent: 2em; white-space: normal;"><span
                        style="list-style: none; margin: 0px; padding: 0px; color: rgb(102, 102, 102);">当单笔交易盈利金额触发(<span
                            style="color: rgb(102, 102, 102); text-indent: 28px;">大于等于</span>)指定的止盈金额时，该笔交易会被强制平仓。</span>
            </p>
            <p style="list-style: none; padding: 0px; text-indent: 2em; white-space: normal;"><span
            ...
            <p style="list-style: none; padding: 0px; text-indent: 2em; white-space: normal;"><span
                        style="list-style: none; margin: 0px; padding: 0px; color: rgb(102, 102, 102);">当单笔交易亏损金额触发(<span
                            style="color: rgb(102, 102, 102); text-indent: 28px;">大于等于</span>)指定的止损金额时，该笔交易会被强制平仓。</span>
            </p>
            <p style="list-style: none; padding: 0px; text-indent: 2em; white-space: normal;"><span
